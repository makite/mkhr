    ...
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route path="/" element={
          ...
          <Route path="system-admin/company-profile" element={<PlaceholderPage />} />
          <Route path="system-admin/branches" element={<PlaceholderPage />} />
          <Route path="system-admin/fiscal-years" element={<PlaceholderPage />} />
          ...
          <Route path="vacancy-management/dashboard" element={<PlaceholderPage />} />
          ...
          <Route path="payroll-management/dashboard" element={<PlaceholderPage />} />
          <Route path="payroll-management/list" element={<PlaceholderPage />} />
          <Route path="payroll-management/reports" element={<PlaceholderPage />} />
        </Route>
