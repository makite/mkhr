...
export const BasicInfoTab = ({
  ...
  // Debug: Log form values to see if data is loaded
  useEffect(() => {
    console.log("BasicInfoTab - Form values:", form.getValues());
  }, [form]);
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
            ...
            >
              ...
              >
                <AccordionTrigger className="px-4 py-3 bg-gradient-to-r from-blue-50 to-white hover:bg-blue-100/50">
              ...
              <AccordionItem value="contact" className="border rounded-lg mb-4">
                <AccordionTrigger className="px-4 py-3 bg-gradient-to-r from-green-50 to-white hover:bg-green-100/50">
                  <div className="flex items-center gap-2">
              ...
              <AccordionItem
                ...
                className="border rounded-lg mb-4"
              >
                <AccordionTrigger className="px-4 py-3 bg-gradient-to-r from-purple-50 to-white hover:bg-purple-100/50">
                  <div className="flex items-center gap-2">
              ...
              <AccordionItem
                ...
                className="border rounded-lg mb-4"
              >
                <AccordionTrigger className="px-4 py-3 bg-gradient-to-r from-orange-50 to-white hover:bg-orange-100/50">
                  <div className="flex items-center gap-2">
                    <div className="h-8 w-8 rounded-full bg-orange-100 flex items-center justify-center">
                      <Clock className="h-4 w-4 text-orange-600" />
                    </div>
                    <span className="font-semibold">Experience Summary</span>
                  </div>
                </AccordionTrigger>
                <AccordionContent className="p-4 bg-white">
                  <div className="space-y-4">
